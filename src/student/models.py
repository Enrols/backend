...
class Student(User):
    ...
    selected_tags = models.ManyToManyField(Tag, blank=True, related_name='students')
    wishlist = models.ManyToManyField(Course, blank=True, related_name='students')
    interests = models.ManyToManyField(Interest, blank=True, related_name='students')
    current_education_level = models.ForeignKey(EducationLevel, on_delete=models.PROTECT, null=True, blank=True, related_name='students') # do not allow deletion of education level if it has a student
    preferred_locations = models.ManyToManyField(Location, blank=True, related_name='students')
